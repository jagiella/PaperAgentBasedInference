...
\begin{flushleft}
{\Large
\textbf\newline{Approximate Bayesian Computing for Parameter Inference in Hybrid Discrete-Continuum Models}
}
\newline
...
\includegraphics[width=\textwidth]{Figures/FitToyData4c}\\
 \textbf{D} \\
\includegraphics[width=\textwidth]{Figures/FitToyData4d}\\
...
\textbf{C}\\
\includegraphics[width=\textwidth]{Figures/FitToyData5d}
