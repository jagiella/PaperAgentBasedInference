...
For details about the ABC~SMC method and our parallel implementation we refer to the \textit{Materials and Methods} section.
...
%%%%%%
\paragraph{Agent-based model of tumor spheroid growth}
